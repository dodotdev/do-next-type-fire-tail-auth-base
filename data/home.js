...
export const navigation = [
  ...
  { name: 'Events', href: '/events', current: false, protected: false },
  { name: 'Membership', href: '/membership', current: false, protected: false },
  // { name: 'Career', href: '/contact', current: false, protected: false },
  { name: 'Contact Us', href: '/contact', current: false, protected: false },
